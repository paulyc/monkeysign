# -*- coding: utf-8 -*-
#
# Monkeysign documentation build configuration file, created by
...
htmlhelp_basename = 'Monkeysigndoc'
...
latex_documents = [
  ('index', 'Monkeysign.tex', u'Monkeysign Documentation',
...
texinfo_documents = [
  ('index', 'Monkeysign', u'Monkeysign Documentation',
   u'Antoine Beaupré', 'Monkeysign', 'One line description of project.',
   'Miscellaneous'),
]
